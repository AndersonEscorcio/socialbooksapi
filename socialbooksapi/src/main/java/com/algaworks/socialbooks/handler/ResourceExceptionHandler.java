...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(LivroNaoEncontradoException.class) //Exceção retornada dessa classe
	...
	@ExceptionHandler(AutorExistenteException.class) //Exceção retornada dessa classe
	...
	@ExceptionHandler(AutorNaoEncontradoException.class) //Exceção retornada dessa classe
	public ResponseEntity<DetalhesErro> handleLivroNaoEncontradoException
	...
	@ExceptionHandler(DataIntegrityViolationException.class) //Exceção retornada dessa classe
	public ResponseEntity<DetalhesErro> handleAutorExistenteException
